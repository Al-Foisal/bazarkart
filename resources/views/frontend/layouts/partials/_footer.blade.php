    ...
    <div class="footer-middle" style="background-color: #f4f4f6;color: black;">
        <div class="container position-static">
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6 pb-0">
                    <div class="widget d-flex justify-content-start">
                        <img src="{{ asset('images/apps.png') }}" style="width: 150px;height: 40px;padding-left: 2rem;" alt="">
                        <img src="{{ asset('images/apps.png') }}" style="width: 150px;height: 40px;padding-left: 2rem;" alt="">
                    </div>
                    <!-- End .widget -->
                </div>
        ...
        <div class="container">
            <div class="footer-bottom d-sm-flex align-items-center" style="border: none;">
                <div class="footer-left">
                    <span class="footer-copyright">Copyright © 2022 BazarKart, All Right Reserved | Design & Developed
                        By QuickTech IT</span>
                </div>
